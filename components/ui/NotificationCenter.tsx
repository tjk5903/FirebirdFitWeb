...
function NotificationItem({ notification, onMarkAsRead }: { 
  ...
  const getBgColor = () => {
    if (notification.read) return 'bg-white dark:bg-slate-800'
    switch (notification.type) {
      case 'workout':
  ...
  return (
    <div
      onClick={handleClick}
      className={`p-3 border-b border-gray-100 dark:border-slate-700 hover:bg-gray-50 dark:hover:bg-slate-700/50 cursor-pointer transition-colors ${getBgColor()}`}
    >
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className="relative p-2 text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-100 dark:hover:bg-slate-700 rounded-full transition-colors"
      >
