    ...
    return (
      <div className={`card-elevated hover-lift ${className}`}>
        <div className="flex items-center justify-between mb-4 sm:mb-6">
          <h3 className="text-lg sm:text-xl font-bold text-gray-900">My Performance</h3>
          ...
          <div className="p-3 bg-gray-50 rounded-lg border border-gray-200/50">
            <div className="flex items-center space-x-2">
              ...
              <div className="flex-1">
                <p className="text-xs text-gray-500 font-medium">Last completed</p>
                <p className="font-semibold text-gray-900">{stats.lastCompletedWorkout.title}</p>
              </div>
